    ...
    <div className={styles.footer_container}>
      <div className={styles.skill_container}>
        <div className={styles.skill_item_container}>
          <div className={styles.skill_title}>Frontend</div>
        ...
        <div className={styles.skill_item_container}>
          <div className={styles.skill_title}>Backend</div>
          <div className={styles.skill_item}>
            <img
        ...
        <div className={styles.skill_item_container}>
          <div className={styles.skill_title}>Mobile</div>
          <div className={styles.skill_item}>
            <img
              src="https://user-images.githubusercontent.com/25181517/183897015-94a058a6-b86e-4e42-a37f-bf92061753e5.png"
              width="50px"
        ...
        <div className={styles.skill_item_container}>
          <div className={styles.skill_title}>Database</div>
          <div className={styles.skill_item}>
            <img
        ...
        <div className={styles.skill_item_container}>
          <div className={styles.skill_title}>Services</div>
          <div className={styles.skill_item}>
            <img
        ...
        <div className={styles.skill_item_container}>
          <div className={styles.skill_title}>Tools</div>
          <div className={styles.skill_item}>
            <img
        ...
        <div className={styles.skill_item_container}>
          <div className={styles.skill_title}>Others</div>
          <div className={styles.skill_item}>
            <img
